...
import svgPaths from "./svg-f71xzkvs0g";

function Button({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-white h-full relative rounded-[10px] shrink-0 w-[349.33px]">
      <div aria-hidden="true" className="absolute border-2 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="content-stretch flex flex-col gap-[13px] items-start px-[26px] py-[28px] relative size-full">{children}</div>
    </div>
  );
}
...
function CardTitleText({ text }: CardTitleTextProps) {
  return (
    <div className="h-[27px] relative shrink-0 w-full">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#111827] text-[16px] top-px whitespace-nowrap">{text}</p>
    </div>
  );
}
...
function ContainerText({ text, additionalClassNames = "" }: ContainerTextProps) {
  return (
    <div className={clsx("bg-[#eff6ff] content-stretch flex h-[24px] items-center px-[12px] py-[4px] relative rounded-[33554400px] shrink-0", additionalClassNames)}>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#2563eb] text-[16px] whitespace-nowrap">{text}</p>
    </div>
  );
}
type Text3Props = {
...
export default function AddPropertyFlowStep1NewOrDraft() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Add Property Flow - Step 1: New or Draft">
      <Sidebar className="h-full relative shrink-0 w-[280px]" />
      <div className="bg-[#fbfbfb] flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="property-detail-page">
                ...
                <div className="h-[24px] relative shrink-0" data-name="Container">
                  <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] h-full items-center relative">
                      ...
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[10px] h-full items-center relative">
                        <div className="h-[20px] relative shrink-0 w-[9px]" data-name="Icon">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 20">
                            <g clipPath="url(#clip0_1_31274)" id="Icon">
                    ...
                    <div className="relative shrink-0 w-[119.906px]" data-name="Text">
                      <Text2 text="SR00015 Land" additionalClassNames="flex-col w-full" />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#ececf0] flex-[1_0_0] min-h-px min-w-px relative rounded-[14px] w-full" data-name="Tab List">
                  <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[3px] relative size-full">
                      <TabButton>
                        <Text3 text="Overview" additionalClassNames="px-[49px]" />
                      </TabButton>
                      <TabButton>
                      ...
                      <TabButton>
                        <Text3 text="Spatial" additionalClassNames="px-[64px]" />
                      </TabButton>
                      <TabButton>
              ...
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-center max-w-[inherit] p-[32px] relative w-full">
                ...
                <div className="content-stretch flex flex-col gap-[8px] h-[60px] items-start relative shrink-0 w-full" data-name="Container">
                  <div className="h-[32px] relative shrink-0 w-full" data-name="section-title">
                    <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] left-0 not-italic text-[#111827] text-[30px] top-0 tracking-[-0.225px] whitespace-nowrap">Add property</p>
                  </div>
                  <div className="h-[20px] relative shrink-0 w-full" data-name="body-text">
                    <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#4b5563] text-[16px] top-0 whitespace-nowrap">Create new record or continue from draft</p>
                  </div>
                </div>
                <div className="content-stretch flex gap-[24px] h-[253px] items-start relative shrink-0 w-full" data-name="Container">
                  <div className="bg-white h-full relative rounded-[14px] shrink-0 w-[349.33px]" data-name="Button">
                    <div aria-hidden="true" className="absolute border-2 border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[14px]" />
                    <div className="content-stretch flex flex-col gap-[13px] items-start px-[26px] py-[28px] relative size-full">
                      <div className="content-stretch flex flex-col gap-[13px] items-start relative shrink-0" data-name="icon-wrapper">
                        <ContainerText text="Fastest" additionalClassNames="w-[66.203px]" />
                      ...
                      <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-[297.33px]" data-name="card-title">
                        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#111827] text-[16px] whitespace-nowrap">Take a photo</p>
                      </div>
                      <div className="content-stretch flex flex-col items-start justify-end relative shrink-0 w-[297.33px]" data-name="body-text">
                        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#4b5563] text-[16px] w-[201px]">Start by taking a photo of your property document</p>
                      </div>
                    </div>
                  </div>
                  <Button>
                    <ContainerText text="Faster" additionalClassNames="w-[60.031px]" />
                    <div className="bg-[rgba(20,184,166,0.1)] content-stretch flex items-center justify-center relative rounded-[14px] shrink-0 size-[64px]" data-name="Container">
                      <Icon1>
                        <path d={svgPaths.p110a37f0} id="Vector" stroke="var(--stroke-0, #14B8A6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                        <path d={svgPaths.p171a9480} id="Vector_2" stroke="var(--stroke-0, #14B8A6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                        <path d="M16 4V20" id="Vector_3" stroke="var(--stroke-0, #14B8A6)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                      </Icon1>
                    </div>
                    <CardTitleText text="Upload document" />
                    <div className="h-[45.5px] relative shrink-0 w-full" data-name="body-text">
                      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#4b5563] text-[16px] top-0 w-[216px]">Start by uploading your property document</p>
                    </div>
                  </Button>
                  <Button>
                    <div className="bg-[#e5e7eb] content-stretch flex h-[24px] items-center px-[12px] py-[4px] relative rounded-[33554400px] shrink-0" data-name="Container">
                      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#4b5563] text-[16px] whitespace-nowrap">If no document</p>
                    </div>
                    <div className="bg-[#f3f4f6] content-stretch flex items-center justify-center relative rounded-[14px] shrink-0 size-[64px]" data-name="Container">
                      <Icon1>
                        <path d={svgPaths.p1b91d620} id="Vector" stroke="var(--stroke-0, #4B5563)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                        <path d={svgPaths.p76546be} id="Vector_2" stroke="var(--stroke-0, #4B5563)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                        <path d="M13.3333 12H10.6667" id="Vector_3" stroke="var(--stroke-0, #4B5563)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                        <path d="M21.3333 17.3333H10.6667" id="Vector_4" stroke="var(--stroke-0, #4B5563)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                        <path d="M21.3333 22.6667H10.6667" id="Vector_5" stroke="var(--stroke-0, #4B5563)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                      </Icon1>
                    </div>
                    <CardTitleText text="Manual input" />
                    <div className="h-[45.5px] relative shrink-0 w-full" data-name="body-text">
                      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#4b5563] text-[16px] top-0 w-[176px]">Enter property information manually</p>
                    </div>
                  </Button>
                </div>
                <div className="content-stretch flex flex-col gap-[16px] h-[122px] items-start relative shrink-0 w-full" data-name="Container">
                  <div className="h-[20px] relative shrink-0 w-full" data-name="subsection-title">
                    <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-0 not-italic text-[#111827] text-[16px] top-0 whitespace-nowrap">Or continue from drafts</p>
                  </div>
                  <div className="bg-white h-[86px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
                    ...
                    <div className="flex flex-col items-center size-full">
                      <div className="content-stretch flex flex-col items-center pb-px pt-[33px] px-[33px] relative size-full">
                        <div className="relative shrink-0 w-full" data-name="body-text">
                          <div className="flex flex-row items-center justify-center size-full">
                            <div className="content-stretch flex items-center justify-center px-[388px] relative w-full">
                              <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#4b5563] text-[16px] text-center whitespace-nowrap">No draft</p>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div className="absolute h-[220px] left-[140px] top-[-200px] w-[740px]" data-name="flow: detail → sidebar">
        <div className="absolute inset-[-4.55%_-1.35%_-4.55%_-7.8%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 807.735 240">
            <g id="flow: detail â sidebar">
              <path d={svgPaths.pd1f1bf0} fill="var(--fill-0, white)" />
              <path d={svgPaths.p2b9c4700} fill="var(--stroke-0, white)" />
            </g>
          </svg>
        </div>
      </div>
