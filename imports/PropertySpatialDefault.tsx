...
import svgPaths from "./svg-54xbl6uow4";
  ...
  return (
    <div className="bg-white relative rounded-[6px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[8px] pr-[16px] py-[8px] relative w-full">{children}</div>
      </div>
    </div>
  );
}
...
function Helper({ text, text1 }: HelperProps) {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#515d66] text-[14px]">{text}</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] relative shrink-0 text-[#14181b] text-[24px] tracking-[-0.144px]">{text1}</p>
    </div>
  );
}

function ChartLegendHelper() {
  return (
    <div className="h-0 relative shrink-0 w-full">
      <div className="absolute inset-[-0.5px_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 225 1">
          <path d="M0 0.5H225" id="Line 4" stroke="var(--stroke-0, #D1D5DB)" />
        </svg>
      </div>
    </div>
  );
...
function BadgeText({ text }: BadgeTextProps) {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">{text}</p>
      <div className="h-[24px] relative shrink-0 w-[44px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 24">
          <g id="toggle">
            <path d={svgPaths.p13136a40} fill="var(--fill-0, #2563EB)" id="Rectangle 2" />
...
export default function PropertySpatialDefault() {
  return (
    <div className="bg-[#f5f6f7] content-stretch flex items-start relative size-full" data-name="Property Spatial - Default">
      <Sidebar className="bg-white h-[900px] relative rounded-[8px] shrink-0" property1="Sidebar Collapse" />
      <div className="bg-[#f5f6f7] h-[900px] relative shrink-0 w-[1360px]" data-name="property-detail-page">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
          <HeaderProperty className="bg-white h-[121px] relative shrink-0 w-full" property1="Spatial" />
          <div className="bg-[#14181b] flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="page-body">
            <div className="flex flex-col items-center size-full">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[48px] items-center pb-[32px] pt-[48px] px-[32px] relative size-full">
                <div className="content-stretch flex gap-[24px] items-start justify-end overflow-clip relative shrink-0 w-full" data-name="layer-toggle">
                  ...
                  <div className="bg-white content-stretch flex flex-col gap-[24px] h-[539px] items-start pb-[32px] pl-[24px] pr-[32px] pt-[24px] relative rounded-[8px] shrink-0 w-[280px]" data-name="content-panel">
                    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="drawing-tools">
                      ...
                      <Wrapper6>
                        <g id="lucide/minus">
                          <path d="M5 12H19" id="Vector" stroke="var(--stroke-0, #14181B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                        </g>
                      </Wrapper6>
                    </div>
                    <div className="h-[203px] relative shrink-0 w-[225px]" data-name="legend-panel">
                      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#2563eb] text-[14px] top-0 whitespace-nowrap">LAYERS</p>
                      <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-0 top-[36px] w-[225px]" data-name="chart-legend">
                        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="chart-ring">
                          <BadgeText text="Satellite View" />
                        </div>
                        <ChartLegendHelper />
                        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="chart-donut">
                          <BadgeText text="Terrain" />
                        </div>
                        <ChartLegendHelper />
                        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="chart-legend">
                          <BadgeText text="Bounderies" />
                        </div>
                        <ChartLegendHelper />
                        <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="chart-center">
                          <BadgeText text="Labels" />
                        </div>
                      </div>
                    </div>
                    <div className="h-[187px] relative shrink-0 w-[225px]" data-name="legend-row">
                      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#2563eb] text-[14px] top-0 whitespace-nowrap">TOOLS</p>
                      <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-0 top-[36px] w-[225px]" data-name="legend-item">
                        <Button>
                          <Wrapper6>
                            <g id="lucide/ruler-dimension-line">
                              <path d={svgPaths.p2e34fe00} id="Vector" stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            </g>
                          </Wrapper6>
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">Measure Distance</p>
                        </Button>
                        <Button>
                          <Wrapper6>
                            <g id="lucide/scan">
                              <path d={svgPaths.p3d6afdc0} id="Vector" stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            </g>
                          </Wrapper6>
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">Measure Area</p>
                        </Button>
                        <Button>
                          <Wrapper6>
                            <g id="lucide/map-pin">
                              <g id="Vector">
                                <path d={svgPaths.p27c543b0} stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                                <path d={svgPaths.p2d59bff0} stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                              </g>
                            </g>
                          </Wrapper6>
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">Drop Pin</p>
                        </Button>
                      </div>
                    </div>
                    <div className="content-stretch flex flex-col gap-[12px] items-start leading-[24px] not-italic relative shrink-0 text-[14px] whitespace-nowrap" data-name="legend-label">
                      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#2563eb]">PROPERTY</p>
                      <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="legend-swatch">
                        <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[#14181b]">SR00015 Land</p>
                        <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#515d66]">Siem Reap, Cambodia</p>
                      </div>
                    </div>
                  </div>
                  <div className="absolute content-stretch flex flex-col gap-[8px] h-[357px] items-center justify-center left-[284px] overflow-clip top-[82px] w-[464px]" data-name="map-badge">
                    <div className="relative shrink-0 size-[118px]" data-name="lucide/box">
                ...
                <div className="bg-white h-[108px] relative rounded-[8px] shrink-0 w-full" data-name="content-panel">
                  <div className="flex flex-row items-center size-full">
                    <div className="content-stretch flex items-center justify-between px-[32px] py-[24px] relative size-full">
                      <div className="content-stretch flex gap-[48px] items-center not-italic relative shrink-0 whitespace-nowrap" data-name="basemap-selector">
                        <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="legend-swatch">
                          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#515d66] text-[14px]">Total Area</p>
                          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] relative shrink-0 text-[#14181b] text-[0px] tracking-[-0.144px]">
                            <span className="leading-[32px] text-[24px]">2,450 m</span>
                            <span className="leading-[32px] text-[15.48px]">2</span>
                          </p>
                        </div>
                        <Helper text="Zoning" text1="Agricultural" />
                        <Helper text="Elevation" text1="125m" />
                        <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="legend-panel">
                          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#515d66] text-[0px] text-[14px]">
                            <span className="leading-[24px]">Price/m</span>
                            <span className="leading-[24px]">2</span>
                          </p>
                          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] relative shrink-0 text-[#14181b] text-[24px] tracking-[-0.144px]">$245</p>
                        </div>
                      </div>
                      <div className="relative shrink-0 size-[48px]" data-name="lucide/chevron-up">
                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
                          <g id="lucide/chevron-up">
                            <path d="M36 30L24 18L12 30" id="Vector" stroke="var(--stroke-0, #515D66)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                          </g>
                        </svg>
                      </div>
                    </div>
