...
import svgPaths from "./svg-pk0c8pttna";
import imgScreenshot20260203At111525Valgate1 from "figma:asset/c255990e52ec7bf4f086de866e987ad53096b004.png";
...
function Helper({ text, text1, additionalClassNames = "" }: HelperProps) {
  return (
    <div className={clsx("content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal items-start leading-[24px] not-italic text-[16px]", additionalClassNames)}>
      <p className="relative shrink-0 text-[#14181b] whitespace-nowrap">{text}</p>
      <p className="relative shrink-0 text-[#acb4bc] w-[286px]">{text1}</p>
    </div>
  );
}
...
export default function AddPropertyFlowStep3BasicInfo() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Add Property Flow - Step 3: Basic Info">
          ...
          <div className="max-w-[1160px] relative shrink-0 w-full" data-name="step-indicator">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start max-w-[inherit] p-[32px] relative w-full">
              <div className="h-[16px] relative shrink-0 w-full" data-name="progress">
                ...
                <div className="absolute bg-[#2563eb] inset-[0_66.67%_0_0] rounded-[16px]" data-name="progress" />
              </div>
              <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#2563eb] text-[16px] whitespace-nowrap">Step 2 of 6: Basic Information</p>
            </div>
          </div>
              ...
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-center max-w-[inherit] p-[32px] relative w-full">
                ...
                <div className="content-stretch flex flex-col gap-[8px] h-[60px] items-start relative shrink-0 w-full" data-name="Container">
                  <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="section-title">
                    <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[#14181b] text-[30px] whitespace-nowrap">Basic Property Information</p>
                  </div>
                  <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="body-text">
                    <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#515d66] text-[16px] whitespace-nowrap">Enter the essential details about your property</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="popover">
                  ...
                  <div className="content-stretch flex flex-col gap-[24px] items-start p-[16px] relative w-full">
                    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="form-section">
                      <Helper text="Dimensions" text1="Set the dimensions for the layer." additionalClassNames="relative shrink-0" />
                      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="form-row">
                        <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Property Name</p>
                        ...
                        <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Property ID</p>
                          <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                            <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                              <Field />
                            </div>
                    ...
                    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="form-section">
                      <Helper text="Location" text1="Set the dimensions for the layer." additionalClassNames="relative shrink-0" />
                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="field-group">
                        <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="field-stack">
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Address Line</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Address Line 2</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                      ...
                      <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="form-row">
                        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative" data-name="field-col">
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">City</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">ZIP/Postal Code</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                        ...
                        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative" data-name="field-col">
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">State/Province</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Country</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                    ...
                    <div className="h-[331px] relative shrink-0 w-[595.33px]" data-name="form-section">
                      <Helper text="Property Details" text1="Set the dimensions for the layer." additionalClassNames="absolute left-0 top-0" />
                      <div className="absolute content-stretch flex gap-[16px] items-start left-0 top-[64px] w-[595.33px]" data-name="field-columns">
                        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative" data-name="field-col">
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Year Built</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Bedrooms</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Parking Spaces</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                        ...
                        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative" data-name="field-col">
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Total Area</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Bathrooms</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="input">
                            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Storage Unit</p>
                            <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="input/with button">
                              <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="default">
                                <Field />
                              </div>
              ...
              <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[442.67px]" data-name="info-sidebar">
                <NavigationMenuContent>
                  <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="summary-item">
                    ...
                    <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Tips</p>
                  </div>
                ...
                <NavigationMenuContent>
                  <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="panel-header">
                    <div className="h-[24px] relative shrink-0 w-[20px]" data-name="lucide/map-pin">
                      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 23.9998">
                        <g id="lucide/map-pin">
                          <rect fill="white" height="23.9998" width="20" />
                          <g id="Vector">
                            <path d={svgPaths.pf0e8000} stroke="var(--stroke-0, #14181B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            <path d={svgPaths.p2cd69f00} stroke="var(--stroke-0, #14181B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                          </g>
                        </g>
                      </svg>
                    </div>
                    <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Location Preview</p>
                  </div>
                  <div className="aspect-[465/299] bg-[#e8eaed] relative rounded-[12px] shrink-0 w-full" data-name="Container">
                    <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
                      <div className="content-stretch flex items-center justify-center pr-[0.016px] relative size-full">
                        <div className="aspect-[1200/696] h-full relative shrink-0" data-name="Screenshot 2026-02-03 at 11-15-25 Valgate 1">
                          <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260203At111525Valgate1} />
                        </div>
                      </div>
                    </div>
                  </div>
