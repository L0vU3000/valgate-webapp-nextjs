...
| **Phase 8 — audit non-property routes** | 🟡 In flight — **8.1 Analytics ✅** · **8.2 Rental audit ✅** · **8.3 Settings ✅ (2026-05-26)** · **8.4 Directory ✅** · **8.5 Estate Planning ✅** · 8.2-wiring partial (LeaseTable deferred to Phase 6.9) | `/analytics` ✅ · `/rental` ✅ audit (wiring partial) · `/settings` ✅ audit + post-wiring · `/directory` ✅ · `/estate-planning` ✅ · `/add-property` · `/` · `/profile` · `/auth/*` |
