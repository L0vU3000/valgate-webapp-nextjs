...
import svgPaths from "./svg-ylpo99djy6";
...
export default function OwnershipPage() {
  return (
    <div className="bg-[#f5f6f7] content-stretch flex items-center relative size-full" data-name="Ownership Page">
      ...
      <div className="bg-[#f5f6f7] content-stretch flex flex-[1_0_0] flex-col items-center min-h-px min-w-px relative" data-name="main-content">
