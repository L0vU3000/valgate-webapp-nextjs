...
import svgPaths from "./svg-qnu8kucgiq";
...
function LucideBox({ children }: React.PropsWithChildren<{}>) {
  return (
...
export default function PropertySpatialExpanded() {
  return (
    <div className="bg-[#f5f6f7] content-stretch flex items-start relative size-full" data-name="Property Spatial - Expanded">
      ...
      <div className="bg-[#f5f6f7] h-[900px] relative shrink-0 w-[1360px]" data-name="property-detail-page">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
          ...
          <div className="bg-[#14181b] flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="page-content">
            <div className="flex flex-col items-center size-full">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[48px] items-center pb-[32px] pt-[48px] px-[32px] relative size-full">
                ...
                <div className="absolute bg-white content-stretch flex flex-col gap-[16px] h-[280px] items-start left-[32px] px-[32px] py-[24px] rounded-[8px] top-[467px] w-[1296px]" data-name="content-panel">
                  <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="panel-toggle">
                    ...
                    <div className="flex items-center justify-center relative shrink-0">
                      <div className="flex-none rotate-180">
                        <div className="relative size-[48px]" data-name="lucide/chevron-up">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
                            <g id="lucide/chevron-up">
                              <rect fill="white" height="48" width="48" />
                              <path d="M36 30L24 18L12 30" id="Vector" stroke="var(--stroke-0, #14181B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                            </g>
                          </svg>
                        </div>
                      </div>
                  ...
                  <div className="content-stretch flex gap-[40px] items-start relative shrink-0" data-name="modal-overlay">
                    <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[14px] whitespace-nowrap">Measurements</p>
                    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[47px]" data-name="modal-card">
                      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[14px] whitespace-nowrap">Zoning</p>
                      <div className="h-0 relative shrink-0 w-full">
                        <div className="absolute inset-[-1px_-2.13%]">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 49 2">
                            <path d="M1 1H48" id="Line 16" stroke="var(--stroke-0, #2563EB)" strokeLinecap="round" strokeWidth="2" />
                          </svg>
                        </div>
                      </div>
                    </div>
                    <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[14px] whitespace-nowrap">Boundaries</p>
                    <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[14px] whitespace-nowrap">Investment</p>
                  </div>
                  <div className="content-stretch flex flex-[1_0_0] items-end justify-between min-h-px min-w-px relative w-full" data-name="empty-state">
                    <div className="bg-white h-full relative rounded-[12px] shrink-0" data-name="Button">
                      ...
                      <div className="flex flex-row items-center size-full">
                        <div className="content-stretch flex gap-[32px] h-full items-center p-[24px] relative">
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="property-card">
                            <div className="content-stretch flex items-center relative shrink-0" data-name="card-title">
                              <div className="content-stretch flex items-center relative shrink-0" data-name="card-title">
                                <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic relative shrink-0 text-[#515d66] text-[16px] whitespace-nowrap">Current Zoning</p>
                              </div>
                            </div>
                            <div className="content-stretch flex items-center relative shrink-0" data-name="Heading 4">
                              <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] not-italic relative shrink-0 text-[#14181b] text-[30px] tracking-[-0.225px] whitespace-nowrap">Agricultural Zone</p>
                            </div>
                          </div>
                          ...
                          <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="list-item-badge">
                            <div className="content-stretch flex flex-col font-['Inter:Medium',sans-serif] font-medium items-start leading-[20px] not-italic relative shrink-0 text-[#515d66] text-[12px] whitespace-nowrap" data-name="list-item">
                    ...
                    <div className="bg-[#2563eb] relative rounded-[6px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0" data-name="Button">
                      <div className="flex flex-row items-center justify-center size-full">
                        <div className="content-stretch flex items-center justify-center px-[24px] py-[8px] relative">
                          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19px] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">Full Details</p>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div className="absolute h-[357px] left-[536px] top-[184px] w-[464px]" data-name="spatial-mode-badge">
