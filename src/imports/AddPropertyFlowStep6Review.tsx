...
import svgPaths from "./svg-561ymn5peh";
...
function InputWithButtonText({ text, additionalClassNames = "" }: InputWithButtonTextProps) {
  return (
    <div className={clsx("content-stretch flex items-start justify-between relative shrink-0 w-[394.67px]", additionalClassNames)}>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[17px] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">{text}</p>
        ...
        <div className="relative shrink-0 size-[17px]">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
            <g id="lucide/check">
              ...
              <path d={svgPaths.p2106f3a0} id="Vector" stroke="var(--stroke-0, #059669)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </g>
          </svg>
        </div>
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19px] not-italic relative shrink-0 text-[#059669] text-[14px] w-[76px]">{"Completed"}</p>
      </div>
    </div>
  );
}
...
function Helper() {
  return (
    <div className="h-0 relative shrink-0 w-full">
      <div className="absolute inset-[-1px_0_0_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 581.33 1">
          <line id="Line 3" stroke="var(--stroke-0, #D1D5DB)" x2="581.33" y1="0.5" y2="0.5" />
        </svg>
      </div>
    </div>
  );
...
function InputWithButton({ text, text1, additionalClassNames = "" }: InputWithButtonProps) {
  return (
    <div className={clsx("content-stretch flex h-[20px] items-start not-italic relative shrink-0 text-[14px] w-full whitespace-nowrap", additionalClassNames)}>
...
function PanelHeaderText({ text }: PanelHeaderTextProps) {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[19px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">{text}</p>
    </div>
  );
}
...
export default function AddPropertyFlowStep6Review() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Add Property Flow - Step 6: Review">
        ...
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center overflow-clip pb-[32px] relative rounded-[inherit] w-full">
              ...
              <div className="max-w-[1160px] relative shrink-0 w-full" data-name="progress-bar">
                <div className="content-stretch flex flex-col gap-[8px] items-start max-w-[inherit] px-[32px] py-[24px] relative w-full">
                  <div className="h-[16px] relative shrink-0 w-full" data-name="progress">
                    ...
                    <div className="absolute bg-[#2563eb] inset-0 rounded-[16px]" data-name="progress" />
                  </div>
                  <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#2563eb] text-[16px] whitespace-nowrap">{`Step 6 of 6: Review & Submit`}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-center max-w-[inherit] px-[32px] py-[24px] relative w-full">
                ...
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Container">
                  <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="section-title">
                    <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[#14181b] text-[30px] whitespace-nowrap">Review Property Details</p>
                  </div>
                  <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="body-text">
                    <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#515d66] text-[16px] whitespace-nowrap">Please review all information before submitting</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative shrink-0 w-full" data-name="form-footer">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[24px] items-start px-[32px] relative w-full">
              <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[629.33px]" data-name="form-panel">
                <NavigationMenuContent>
                  <PanelHeaderText text="Property Overview" />
                  <Helper />
                  <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="summary-list">
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="form-row">
                      <InputWithButton text="Purchase Price" text1="Sunset Villa" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="summary-row">
                      <InputWithButton text="Property Type" text1="Residential House" additionalClassNames="gap-[16px]" />
                    </div>
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="summary-item">
                      <InputWithButton text="Property ID" text1="SR00015" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="form-section">
                      <InputWithButton text="Address" text1="#24, Street 337, Sangkat Boeung Kak, Phnom Penh" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="field-group">
                      <InputWithButton text="Year Built" text1="2018" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="field-columns">
                      <InputWithButton text="Bedrooms" text1="3" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="form-section">
                      <InputWithButton text="Bathrooms" text1="2" additionalClassNames="justify-between" />
                    </div>
                  </div>
                </NavigationMenuContent>
                <NavigationMenuContent>
                  <PanelHeaderText text="Financial Information" />
                  <Helper />
                  <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="summary-list">
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="form-row">
                      <InputWithButton text="Purchase Price" text1="$250,000" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="summary-row">
                      <InputWithButton text="purchase Date" text1="Jan 15 , 2024" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col h-[20px] items-start relative shrink-0 w-full" data-name="summary-item">
                      <InputWithButton text="Current Market Value" text1="$275,000" additionalClassNames="justify-between" />
                    </div>
                    <Helper />
                    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="form-section">
                      <InputWithButton text="Ownership Status" text1="Financed" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="form-section">
                      <InputWithButton text="Outstanding Mortgage" text1="$180,000" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="field-group">
                      <InputWithButton text="Monthly Payment" text1="$1,234" additionalClassNames="justify-between" />
                    </div>
                    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="field-columns">
                      <InputWithButton text="Interest Rate" text1="4.5%" additionalClassNames="justify-between" />
                    </div>
                  </div>
                </NavigationMenuContent>
                <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="navigation menu content">
                  <div aria-hidden="true" className="absolute border border-[#e8eaed] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[0px_4px_6px_0px_rgba(0,0,0,0.09)]" />
                  <div className="content-stretch flex flex-col gap-[24px] items-start p-[24px] relative w-full">
                    <PanelHeaderText text="Photos and Documents" />
                    <Helper />
                    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="photos-summary">
                      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[17px] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">Photos Uploaded: 7 photos</p>
                      <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="upload-grid">
                        <div className="bg-white content-stretch flex flex-col gap-[12px] items-center justify-center p-[24px] relative rounded-[12px] shrink-0 size-[137px]" data-name="Button">
                          ...
                          <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="icon-wrapper">
                            <div className="bg-[#f0f9ff] content-stretch flex items-center justify-center relative rounded-[16px] shrink-0 size-[54px]" data-name="Container">
                              <Icon />
                            </div>
                          </div>
                        ...
                        <div className="bg-[#e8eaed] content-stretch flex flex-col items-center justify-center p-[24px] relative rounded-[12px] shrink-0 size-[137px]" data-name="Button">
                          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19px] not-italic relative shrink-0 text-[#6b7684] text-[14px] whitespace-nowrap">+4 more</p>
                        </div>
                      </div>
                    </div>
                    <div className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">
                      <p className="mb-0">Documents Uploaded: 3 documents</p>
                      <p className="mb-0">Title_Deed_SR00015.pdf</p>
                      <p className="mb-0">Property_Inspection_Report.pdf</p>
                      <p className="mb-0">Purchase_Agreement_2024.pdf</p>
                      <p>&nbsp;</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[442.67px]" data-name="info-sidebar">
                <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="navigation menu content">
                  ...
                  <div className="content-stretch flex flex-col gap-[16px] items-start p-[24px] relative w-full">
                    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="panel-header">
                      ...
                      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Property Summary</p>
                    </div>
                    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[394.67px]" data-name="form-row">
                      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[394.67px]" data-name="input/with button">
                        <div className="content-stretch flex items-center relative shrink-0" data-name="status-badge">
                          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19px] not-italic relative shrink-0 text-[#059669] text-[14px] whitespace-nowrap">Status: Ready to Submit</p>
                        </div>
                        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[17px] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">Completion: 100%</p>
                      </div>
                      <div className="bg-[#059669] h-[16px] rounded-[16px] shrink-0 w-full" data-name="progress" />
                    </div>
                    <Helper1 />
                    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="summary-list">
                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="form-row">
                        <InputWithButtonText text="Required Fields:" additionalClassNames="h-[20px]" />
                      </div>
                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="summary-row">
                        <InputWithButtonText text="Property Type:" />
                      </div>
                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="summary-item">
                        <InputWithButtonText text="Basic Info:" additionalClassNames="h-[20px]" />
                      </div>
                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="form-section">
                        <InputWithButtonText text="Financial Info:" additionalClassNames="h-[20px]" />
                      </div>
                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="field-group">
                        <InputWithButtonText text="Photos:" additionalClassNames="h-[20px]" />
                      </div>
                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="field-columns">
                        <InputWithButtonText text="Documents:" additionalClassNames="h-[20px]" />
                      </div>
                      <Helper1 />
                    </div>
                    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="summary-item">
                      <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[394.67px] whitespace-nowrap" data-name="input/with button">
                        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[17px] not-italic relative shrink-0 text-[#515d66] text-[14px]">Estimated Value</p>
                        <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[#14181b] text-[30px]">$70,000</p>
                      </div>
                    </div>
                  </div>
                </div>
                <NavigationMenuContent>
                  <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="summary-item">
                    ...
                    <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#14181b] text-[16px] whitespace-nowrap">Next Steps</p>
                  </div>
                  <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#515d66] text-[14px] whitespace-nowrap">
                    <p className="leading-[21px] mb-0">After submission:</p>
                    <ul className="list-disc">
                      <li className="mb-0 ms-[21px]">
                        <span className="leading-[21px]">1. Property added to portfolio</span>
                      </li>
                      <li className="mb-0 ms-[21px]">
                        <span className="leading-[21px]">2. Generate property reports</span>
                      </li>
                      <li className="mb-0 ms-[21px]">
                        <span className="leading-[21px]">3. Set up rent collection</span>
                      </li>
                      <li className="ms-[21px]">
                        <span className="leading-[21px]">4. Add maintenance schedule</span>
                      </li>
                    </ul>
                  </div>
                </NavigationMenuContent>
