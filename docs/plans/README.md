...
| `plan-9fbe4bdd5e7f4caa` | Revamp Client Activity Tab → day-grouped timeline + real audit log | in_progress (decisions locked A/A/A/A, implemented; tsc+eslint green, QA pending) — OpenSpec `revamp-client-activity-tab` | [revamp-client-activity-tab.md](./revamp-client-activity-tab.md) | [open](https://plan.agent-native.com/plans/plan-9fbe4bdd5e7f4caa) |
