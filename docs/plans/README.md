...
| `plan-e40b6ac387ea480f` | Phase 4 — Shared Read Cache with Upstash (Vercel-native, client perf) | review (locked: Vercel + measured; one root-cause confirmation open) | [client-perf-phase4-redis.md](./client-perf-phase4-redis.md) | [open](https://plan.agent-native.com/plans/plan-e40b6ac387ea480f) |
